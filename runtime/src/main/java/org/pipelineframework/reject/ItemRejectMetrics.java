...
/** Compatibility delegates for item-reject metrics. */
public final class ItemRejectMetrics {
    private ItemRejectMetrics() { }

    private static ItemRejectMetricsRecorder delegate() {
        return TelemetryCompatibilityAccess.adapter(ItemRejectMetricsRecorder.class, ItemRejectMetricsRecorder::new);
    }
