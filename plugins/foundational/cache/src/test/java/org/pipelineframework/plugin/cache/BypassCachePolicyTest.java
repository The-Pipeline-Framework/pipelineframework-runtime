...
class BypassCachePolicyTest {
    ...
    @Test
    void handle_BypassesCache() {
        CacheManager cacheManager = mock(CacheManager.class);
        BypassCachePolicy policy = new BypassCachePolicy();
        ...
        assertEquals(CacheStatus.BYPASS, PipelineCacheStatusHolder.getAndClear());
